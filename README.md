# You will find the code in index.js file

# Instruction To Run The Code

These are the few steps to run this code

- Run node index in terminal and it will create add the result in the ** test-output.json ** file.
